...
$title = "TAGIHAN PEMBAYARAN MURID";
    ...
    $content .= '<table class="invoice">
				...
				<table class="invoice-content" cellpadding="2">
					...
					<tr>
						...
						<td height="15px" style="border:1px solid #000; text-align: center;">Pembayaran'.$mode. ' untuk kelas '.$kelas->matpel_title.'</td>
						...
						<td height="15px" style="border:1px solid #000; text-align: center;">Rp '.$harga.',-</td>
					</tr>
					<tr>
						...
						<td style="border-right:1px solid #000; border-bottom:1px solid #000; text-align: center;">Rp '.$harga.',-</td>
					</tr>
				</table>
			...
			<p style="font-size: 24px"><i>* Harap melakukan pembayaran maksimal 2 hari dari tanggal Invoice</i></p>
