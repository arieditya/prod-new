<html>
    <body>
        ...
        <p>
            Anda telah menyelesaikan kelas berikut:
        </p>
        <p>
        ...
        <p>
            Pembayaran sebesar 50% dari akhir paket belajar sudah dikirimkan ke rekening Anda. Untuk melihat rincian bukti pembayaran, silahkan klik link berikut ini: <a href="<?php echo base_url();?>guru/simpan_pdf/<?php echo $kode;?>">cek bukti pembayaran</a>
        </p>
        <p>
