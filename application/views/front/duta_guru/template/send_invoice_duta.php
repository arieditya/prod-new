<html>
    <body>
	   <p><img src="<?php echo base_url().'images/header-logo.png';?>" width="150px"/></p><br/>
        <p>Kpd. <?php echo $duta->duta_guru_nama;?>,</p>
        <p>
            <i>Referral</i> Anda telah menyelesaikan kelas berikut:
        </p>
        <p>
            <b>Murid :</b> <?php echo $kelas->murid_nama;?><br/>
        ...
        <p>
		  Pembayaran <i>referral fee</i>duta murid sudah dikirimkan ke rekening Anda<br/>
            Untuk rincian bukti pembayaran, silahkan klik link berikut: <a href="<?php echo base_url();?>duta_guru/simpan_pdf/<?php echo $kode;?>/murid">kirim bukti pembayaran</a>
        </p>
        <p>
