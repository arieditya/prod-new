<html>
<head>
<link rel="canonical" href="http://www.ruangguru.com/duta_guru/bank" />
            ...
            <div id="profile-guru-content">
                <div id="pgc-wrap">
                    ...
                    <div class="pgc-section">
                        <p class="text-13">Rekening Bank yang terdaftar di akun Ruangguru Anda saat ini adalah:</p>
                    </div>
                    <div class="pgc-section">
                        ...
                        <div class="header center">
                            <span><?php echo $guru->duta_guru_bank_rekening;?> - <?php echo $guru->duta_guru_bank_pemilik;?></span>
                        </div>
                        <?php else:?>
                        <div class="header center bold">
                    ...
                    <div class="pgc-section">
                        <div class="content">
                            ...
                            <form id="bank-form" class="profile-form" action="<?php echo base_url(); ?>duta_guru/bank_submit" method="post">
                                <table cellpadding="5">
                                    <tr>
                                        <td>Bank</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="norek" name="rekening" type="text" class="validate[required,custom[onlyNumberSp]] text" value=""  width="250"/>
                                        </td>
                                    </tr>
                                    <tr>
