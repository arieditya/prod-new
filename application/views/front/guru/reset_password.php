<html>
<head>
<link rel="canonical" href="http://www.ruangguru.com/guru/reset_password" />
    ...
    <div id="content-wrap">
        ...
        <div id="login-guru">
            ...
            <div id="login-guru-content" class="guru-content">
                ...
                <?php if($this->session->flashdata('reset_pass_guru_notif')):?>
                <div class="guru-notif">
                    <?php echo $this->session->flashdata('reset_pass_guru_notif');?>
                </div>
                <?php endif;?>
                <form id="login-guru-form" class="guru-form" method="post" action="<?php echo base_url();?>guru/reset_password_submit">
                    <table>
                        <tr>
