		...
		<nav class="navbar-collapse collapse">
			<div class="white-navbar">
				<ul class="nav navbar-nav navbar-left">
					...
					<li>
						<h2><a href="<?php echo base_url();?>kelas">Galeri Kelas</a></h2>
					</li>
					<li>
...
?>
			...
			<div id="inline1" style="width:400px;display: none;">
				...
				<form id="login_form_murid" name="login_form_murid" method="post" action="">
					<p>
						<label for="login_name">Login: </label>
						<input type="email" class="form-control" id="login_email" name="email_murid" placeholder="your@email.com" />
					</p>
					<p>
						<label for="login_pass">Password: </label>
						<input type="password" class="form-control" id="login_password" name="password_murid" />
					</p>
					<p>
						<a onclick="document.login_form_murid.submit();return false;" class="pull-right btn btn-lg btn-success">Sign In</a>
					</p>
				</form>
			</div>
