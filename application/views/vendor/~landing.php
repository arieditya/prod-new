...
<html lang="en">
    ...
    <body>
        <section id="header">
            <div class="container">
				<div class="row">
					<div class="col-md-offset-1 col-md-5 padbottom-40">
						<h1 class="bold pink text-center">Bikin Kelas Untuk Umum</h1>
						<p class="text-center">Punya ilmu atau keahlian yang bisa dibagi untuk orang banyak? Kenapa tidak menyelenggarakan kelas?</p>
						<ul class="btn-how-to">
							<li class="btn-pinky shadow"><a href='#'>Cara Kerja</a></li>
							<li class="btn-pinky-active shadow"><a href='#'>Daftar kelas pertama gratis!</a></li>
						</ul>
					</div>
					<div class="col-md-4">
						<img src="<?php echo base_url();?>images/img-kelas.png">
					</div> 
				</div>
			</div>
        </section>
