...
<div class="row list-orange">
	...
	<div class="row bottom-30 bg-all">
		<div class="col-md-offset-2 col-md-8">
			...
			<div class="bg-section padding-content shadow">
				<div id="form-tabs">
					<ul class="nav nav-tabs" role="tablist">
						...
						<li id="tab_jadwal" class="<?php echo $tabs=='schedule'?'active':''?>"><a href="#schedule" role="tab" data-toggle="tab">Jadwal</a></li>
						<li id="tab_biaya" class="<?php echo $tabs=='biaya'?'active':''?>"><a href="#biaya" role="tab" data-toggle="tab">Biaya</a></li>
						<?php
							endif;
						?>
						<li id="tab_summary" class="<?php echo $tabs=='summary'||(empty($tabs)&& $class->active > 0)?'active':''?>"><a href="#summary" role="tab" data-toggle="tab">Summary</a></li>
						<?php 
							if($class->active > 0):
						?>
						<li id="tab_attendance" class="<?php echo $tabs=='attendance'?'active':''?>"><a href="#attendance" role="tab" data-toggle="tab">Attendance</a></li>
						<li id="tab_discount" class="<?php echo $tabs=='discount'?'active':''?>"><a href="#discount" role="tab" data-toggle="tab">Discount</a></li>
						<li id="tab_email_blast" class="<?php echo $tabs=='email'?'active':''?>"><a href="#email" role="tab" data-toggle="tab">Email to Participant</a></li>
						<?php
							endif;
						?>
				</ul>
...
?>
						...
						<div class="row">
							...
							<div class="col-md-8">Rp. <?php echo number_format($biaya->price_per_session, 0, ',','.'); ?>,--</div>
						</div>
						<hr />
						<div class="row">
							<div class="col-md-4">Total</div>
							<div class="col-md-8">Rp. <?php echo number_format($biaya->price_per_session * $jadwal->num_rows(), 0, ',','.'); ?>,--</div>
						</div>
						<hr />
						<div class="row">
							<div class="col-md-4">Potongan harga</div>
							<div class="col-md-8">Rp. <?php echo number_format($biaya->discount, 0, ',','.');?></div>
						</div>
						<hr />
						<div class="row">
							<div class="col-md-4">Total sesudah diskon</div>
							<div class="col-md-8">Rp. <?php echo number_format(($biaya->price_per_session * $jadwal->num_rows()) - $biaya->discount, 0, ',','.')?></div>
						</div>
						<hr />
						<div class="row">
...
?>
						<p>Class Topic: <?php echo $sched_attendance['topik'];?></p>
						<p>Class Time: <?php echo $sched_attendance['waktu'];?></p>
						<p>Peserta: </p>
						<ul>
<?php 
...
?>
					...
					<div class="tab-pane <?php echo $tabs=='email'?'active':''; ?>" id="email">
						<form class="form-horizontal">
							<label class="control-label col-md-2">Penerima</label>
							<div class="col-md-10">
								<div class="checkbox">
									<label><input type="checkbox" />Murid</label><br />
								</div>
								<div class="checkbox">
									<label><input type="checkbox" />Pemohon</label><br />
								</div>
								<div class="checkbox">
									<label><input type="checkbox" />Murid dan Pemohon</label>
								</div>
							</div>
							<div class="form-group">
							...
							<button class="col-md-offset-2 btn btn-lg btn-info">Send</button>
						</form>
					</div>
					<div class="tab-pane <?php echo $tabs=='discount'?'active':''; ?>" id="discount">
						<div class="blue-bar" style="margin: 20px 0;">
							<h4>Class Discount Management</h4>
						</div>
						<div class="row">
							<div class="col-md-6">
<?php 
...
?>
							...
							<div class="col-md-6">
								...
								<button class="btn btn-pink">Tambah Kode</button>
							</div>
						</div>
						<h4>Create new</h4>
						<form class="form-inline" method="post" action="<?php echo base_url();?>vendor/kelas/add_discount">
							<input type="hidden" value="<?php echo $class->id;?>" name="id" />
							<div class="form-group">
								<div class="radio-inline">
									<div class="radio">
										<label><input type="radio" name="scope" value="target" /><span>Targeted</span></label>
									</div>
								</div>
								<div class="radio-inline">
									<div class="radio">
										<label><input type="radio" name="scope" value="public" /><span>Public</span></label>
									</div>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">Kode Diskon</label>
								<div class="input-group col-md-5">
									<input type="text" id="code_discount" name="code_discount" class="form-control" />
									<span class="input-group-btn">
										<button id="generate_code" type="button" class="btn btn-pink">Auto Generate</button>
									</span>
								</div>
							</div>
							<div class="form-group">
										...
										<div class="col-md-12">
											<div class="input-group">
												<span class="input-group-addon">
													<input type="radio" name="nominal_type" value="idr" />
												</span>
												<input type="text" class="form-control" name="nominal_value" id="idr_value" />
									...
									<div class="row">
										<div class="col-md-12">
											<div class="input-group">
												...
												<input type="text" class="form-control" name="nominal_value" id="percent_value" />
...
<script type="application/javascript">
	$(document).ready(function(){
		...
		return false;
							...
							Jumlah penggunaan
							<br />
							<input type="radio" name="jumlah" value="*" />Tidak terbatas
							<input type="radio" name="jumlah" value="" /><input type="number" name="usage_qty" />Penggunaan
							<br />
							Masa berlaku:
							<br />
							Mulai: 
							<input type="radio" name="begin" value="*" />Sejak awal pendaftaran
							<input type="radio" name="begin" value="" />Tgl <input type="text" class="jadwal_date" data-date-format="YYYY-MM-DD" name="begin_date" />
							<br />
							Hingga: 
							<input type="radio" name="ended" value="*" />Berakhirnya pendaftaran
							<input type="radio" name="ended" value="" />Tgl <input type="text" class="jadwal_date" data-date-format="YYYY-MM-DD" name="ended_date" />
							<div class="row">
