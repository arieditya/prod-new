			...
			<div class="bg-section padding-content shadow">
				<div id="form-tabs">
					<ul class="nav nav-tabs-sq" role="tablist">
						...
						<li id="tab_email" class="<?php echo $tabs=='email_blast'?'active':''?>"><a href="#email_blast" role="tab" data-toggle="tab">Komunikasi</a></li>						<?php
							endif;
						?>
				</ul>
					...
					<div class="tab-pane <?php echo $tabs=='diskon'?'active':''?>" id="diskon">
						...
						<div class="col-md-10">
							<div class="form-group">
								...
								<ul id="type-disc">
									<li><input type="radio" name="tipe" value="1"/>&nbsp;Targeted</li>
									<li><input type="radio" name="tipe" value="2"/>&nbsp;Publik (Diskon terpasang untuk semua murid, tidak ada pengecualian/targeted)</li>
								</ul>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="col-md-4">
									<input class="form-control" id="kode_publik" type="text" name="kode_publik"/>
								</div>
							</div>
							<div class="form-group">
								<h5 class="bold pink">Jumlah Penggunaan</h5>
								<input id="tipe_user" type="radio" value="1"/>&nbsp;Tidak terbatas<br/>
								<input id="tipe_user" type="radio" value="2" class="pull-left"/>&nbsp;
								<div class="col-md-2">
									<input type="text" name="jml_user" class="form-control"/>
						...
						<div class="col-md-8">
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input class="form-control" id="tgl_mulai" name="tgl_mulai"/>
								</div>
								<label class="col-md-1 control-label">
									Jam
								</label>
								<div class="col-md-3">
									<input class="form-control" id="jam_mulai" name="jam_mulai"/>
								</div>
							</div>
						</div>
						<div class="col-md-10">
