 ...
 */
	...
	$img_link = 'https://maps.googleapis.com/maps/api/staticmap?size=640x480&maptype=roadmap&'.$marks;
?><!DOCTYPE html>
<html>
<head>
	<style>
...
<body>
	<div style="display: inline-block; vertical-align: top;">
		<img src="<?php echo $img_link;?>" id="img_holder" />
	</div>
	<div style="display: inline-block; vertical-align: top;">
...
<script type="application/javascript">
	...
	var img_url = 'https://maps.googleapis.com/maps/api/staticmap?size=640x480&maptype=roadmap&markers=color:red%7C';
	...
	$(document).ready(function(){
		...
		$('.selectable').hover(
		function(){
			var dt =  $('.loc_selector',this).data('loc');
			$('#img_holder').attr('src', img_url+latlng[dt]);
		},
		function(){
			$('#img_holder').attr('src', '<?php echo $img_link;?>');
		});
	});
</script>
</html>